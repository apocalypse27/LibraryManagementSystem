...
public class borwrEditAddDialogController {
    ...
    private boolean isInputValid() {
        ...
        if (ssnField.getText() == null || ssnField.getText().length() == 0) {
            errorMessage += "No valid SSN entered!\n"; 
        }
        ...
        if (phoneField.getText() == null || phoneField.getText().length() <9) {
            errorMessage += "Not valid phone number. Must be a 9 digit num!\n"; 
        }
